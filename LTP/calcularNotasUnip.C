...
int main() {
    ...
    if (nota < 7) {
        exame = 10 - nota ;
        printf("OBSERVACAO: VOCE ESTA DE EXAME E PRECISA TIRAR NO MINIMO %f PARA SER APROVADO\n", exame);
    }
    if (pim <= 1.39) {
